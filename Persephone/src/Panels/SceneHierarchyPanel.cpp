...
namespace Juno
{
	...
	void SceneHierarchyPanel::OnImGuiRender()
	{
		...
		//Right click on blank space will open a menu
		if (ImGui::BeginPopupContextWindow(0, 1, false))
		{
			if (ImGui::MenuItem("Create Empty"))
				m_SelectionContext = m_Context->CreateEntity("Game Object");
	...
	void SceneHierarchyPanel::DrawEntityNode(Entity entity)
	{
		...
		ImGuiTreeNodeFlags flags = ((m_SelectionContext == entity) ? ImGuiTreeNodeFlags_Selected : 0) | ImGuiTreeNodeFlags_OpenOnArrow | ImGuiTreeNodeFlags_Leaf | ImGuiTreeNodeFlags_SpanAvailWidth;
	...
	static void DrawComponent(const std::string& name, Entity entity, UIFunction uiFunction)
	{
		...
		if (entity.HasComponent<T>())
		{
			...
			ImGui::Separator();
			std::string fullname = name + " Component";
			bool open = ImGui::TreeNodeEx((void*)typeid(T).hash_code(), treeNodeFlags, fullname.c_str());
			ImGui::PopStyleVar();
