...
namespace Juno
{
	...
	static void SerializeEntity(YAML::Emitter& out, Entity entity)
	{
		...
		out << YAML::Key << "EntityID" << YAML::Value << "12335254987"; // TODO: Entity ID to go here
	...
	bool SceneSerializer::Deserialize(const std::string& filepath)
	{
		...
		JUNO_CORE_TRACE("Deserializing scene '{0}'", sceneName);
		...
		if (entities)
		{
			for (auto entity : entities)
			{
				...
				JUNO_CORE_TRACE("Deserialized entity with ID = {0}, name = {1}", uuid, name);
